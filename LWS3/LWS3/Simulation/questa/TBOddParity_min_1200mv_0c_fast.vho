...
ENTITY 	EN_OddParity IS
	...
	IsOdd : BUFFER std_logic
	);
END EN_OddParity;

-- Design Ports Information
-- IsOdd	=>  Location: PIN_M7,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- X[4]	=>  Location: PIN_M8,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- X[5]	=>  Location: PIN_L1,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
SIGNAL \IsOdd~0_combout\ : std_logic;
SIGNAL \IsOdd~1_combout\ : std_logic;
...
\IsOdd~0\ : cycloneive_lcell_comb
-- Equation(s):
-- \IsOdd~0_combout\ = \X[1]~input_o\ $ (\X[3]~input_o\ $ (\X[0]~input_o\ $ (\X[2]~input_o\)))
...
PORT MAP (
	...
	datac => \X[0]~input_o\,
	datad => \X[2]~input_o\,
	combout => \IsOdd~0_combout\);

-- Location: LCCOMB_X1_Y45_N16
\IsOdd~1\ : cycloneive_lcell_comb
-- Equation(s):
-- \IsOdd~1_combout\ = \X[5]~input_o\ $ (\X[4]~input_o\ $ (\X[6]~input_o\ $ (\IsOdd~0_combout\)))
...
PORT MAP (
	...
	datab => \X[4]~input_o\,
	datac => \X[6]~input_o\,
	datad => \IsOdd~0_combout\,
	combout => \IsOdd~1_combout\);
