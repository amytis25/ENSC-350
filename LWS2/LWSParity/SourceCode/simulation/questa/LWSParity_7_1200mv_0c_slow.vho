...
-- Design Ports Information
-- IsOdd	=>  Location: PIN_L1,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- X[0]	=>  Location: PIN_K2,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- X[1]	=>  Location: PIN_K1,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- X[4]	=>  Location: PIN_J1,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- X[5]	=>  Location: PIN_J2,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- X[6]	=>  Location: PIN_L6,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- Equation(s):
-- \gen_recursive:xor_inst|R~0_combout\ = \X[0]~input_o\ $ (\X[1]~input_o\ $ (\X[3]~input_o\ $ (\X[2]~input_o\)))
...
-- Equation(s):
-- \gen_recursive:xor_inst|R~combout\ = \X[6]~input_o\ $ (\X[5]~input_o\ $ (\X[4]~input_o\ $ (\gen_recursive:xor_inst|R~0_combout\)))
...
PORT MAP (
	...
	datab => \X[5]~input_o\,
	datac => \X[4]~input_o\,
	datad => \gen_recursive:xor_inst|R~0_combout\,
